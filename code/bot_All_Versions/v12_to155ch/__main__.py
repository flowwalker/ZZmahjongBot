"""国标麻将 Botzone Bot — BiLSTM+SelfAttention 模型版 (155ch, 22.8M)"""
...
if __name__ == '__main__':
    ...
    for p in [os.path.join(os.path.dirname(__file__), 'model_final_bilstm_attn.pt'),
              'model_final_bilstm_attn.pt',
              'data/model_final_bilstm_attn.pt',
              '/data/mahjong/model_final_bilstm_attn.pt']:
        if os.path.exists(p):
