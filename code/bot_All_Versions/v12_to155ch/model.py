"""国标麻将 BiLSTM + SelfAttention 模型 — 155通道"""
...
class CNNModel(nn.Module):
    def __init__(self, in_channels=155):
        ...
        # 3. 残差塔 Stage1: 8× ResBlock-SE @256ch
        self._stage1 = nn.ModuleList([ResidualBlock(256) for _ in range(8)])
        ...
        # 5. 残差塔 Stage2: 8× ResBlock-SE @128ch
        self._stage2 = nn.ModuleList([ResidualBlock(128) for _ in range(8)])
        ...
        # Self-attention
        lstm_out_dim = 256  # Bidirectional: 128×2
    ...
    def _apply_orthogonal_init(self):
        ...
        # 纯 SL：无 Value Head，仅初始化 Policy 输出层
    ...
    def forward(self, input_dict: dict):
        ...
        # 纯 SL：无 Value Head，返回 dummy 兼容训练脚本
