...
if __name__ == '__main__':
    ...
    for p in [os.path.join(os.path.dirname(__file__), 'model_cnn_Res_Mish_SE_Large.pt'),
              'model_cnn_Res_Mish_SE_Large.pt',
              'data/model_cnn_Res_Mish_SE_Large.pt',
              '/data/mahjong/model_cnn_Res_Mish_SE_Large.pt']:
        if os.path.exists(p):
