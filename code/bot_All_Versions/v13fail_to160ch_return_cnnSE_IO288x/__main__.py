"""国标麻将 Botzone Bot — 纯 CNN+SE 模型版 (160ch)"""
...
if __name__ == '__main__':
    ...
    for p in [os.path.join(os.path.dirname(__file__), 'model_final_pure_cnnSE.pt'),
              'model_final_pure_cnnSE.pt',
              'data/model_final_pure_cnnSE.pt',
              '/data/mahjong/model_final_pure_cnnSE.pt']:
        if os.path.exists(p):
