"""国标麻将 Botzone Bot — 224通道 V3 超级特征版"""

import os
import sys
sys.stdout = os.fdopen(sys.stdout.fileno(), 'w', 1)  # Botzone pipe 行缓冲
...
if __name__ == '__main__':
    ...
    for p in [os.path.join(os.path.dirname(__file__), 'model_final2.pt'),
              'model_final2.pt',
              'data/model_final2.pt',
              '/data/mahjong/model_final2.pt']:
        if os.path.exists(p):
