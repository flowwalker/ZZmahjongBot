"""国标麻将 Botzone Bot — SelfAttention+位置编码 模型版 (160ch)"""
...
if __name__ == '__main__':
    ...
    for p in [os.path.join(os.path.dirname(__file__), 'model_final_selfattn_pos.pt'),
              'model_final_selfattn_pos.pt',
              'data/model_final_selfattn_pos.pt',
              '/data/mahjong/model_final_selfattn_pos.pt']:
        if os.path.exists(p):
