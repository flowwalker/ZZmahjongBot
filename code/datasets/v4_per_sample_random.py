...
class MemPreloadDataset(Dataset):
    ...
    两种模式:
      ...
      2. per_sample_random=False: 固定 n_aug 个变换，每个样本逐一增强（原有行为）
    """

    def __init__(self, data_dir='data', begin=0.0, end=1.0, n_aug=288,
                 per_sample_random=False):
        t0 = time.time()
        ...
        elif self.n_aug in (2, 12, 72, 288):
